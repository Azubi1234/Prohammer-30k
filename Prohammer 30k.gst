...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-a1d2-5ede-e74f-7479" name="Prohammer 30k" revision="17" battleScribeVersion="2.03" authorName="Prohammer 30k Project" type="gameSystem">
  ...
  <categoryEntry id="cat-retinue" name="Retinue" hidden="false" /><categoryEntry id="cat-dg-mobile" name="Death Guard Mobile Support Limit" hidden="true" /></categoryEntries>
  <forceEntries>

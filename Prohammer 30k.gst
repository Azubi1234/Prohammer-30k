...
<ns0:gameSystem xmlns:ns0="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-a1d2-5ede-e74f-7479" name="Prohammer 30k" revision="34" battleScribeVersion="2.03" authorName="Prohammer 30k Project" type="gameSystem">
      ...
      <ns0:categoryLinks>
        ...
        <ns0:categoryLink id="fl-heavy" name="Heavy Support" hidden="false" targetId="cat-heavy">
          ...
          <ns0:modifiers>
            ...
            <ns0:modifier id="r44-nl-heavy-max" type="set" value="1" field="fl-heavy-max">
              <ns0:conditions>
                <ns0:condition type="atLeast" value="1" field="selections" scope="roster" childId="legion-viii" shared="true" includeChildSelections="true" includeChildForces="false" />
              </ns0:conditions>
            </ns0:modifier>
            <ns0:modifier id="r44-ba-revelation-heavy-max" type="set" value="1" field="fl-heavy-max">
              <ns0:conditions>
            ...
            <ns0:modifier id="r45-we-berserker-heavy-max" type="set" value="1" field="fl-heavy-max">
              <ns0:conditions>
                <ns0:condition type="atLeast" value="1" field="selections" scope="roster" childId="r25-rite-xii-0-berserker-assault" shared="true" includeChildSelections="true" includeChildForces="false" />
              </ns0:conditions>
            </ns0:modifier>
